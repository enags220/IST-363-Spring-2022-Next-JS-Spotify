...
/*export function getAlbums() {
    const albums = [
        ...
        },
        {
            ...
            slug: "in-my-lifetime-vol-1",
            featuredImage: {
                src: "in-my-lifetime-vol-1.jpg",
                alt: "In My Lifetime, Vol. 1",
                width: 160,
                height: 160
            }
        },
        {
            ...
            featuredImage: {
                src: "reasonable-doubt.jpg",
                alt: "Reasonable Doubt",
                width: 160,
                height: 160
            }
        },
...
export function filterTracksByGenre(tracks, activeGenre) {
    //1. create new array
    let filteredTracks = [];
    //2. loop through existing bigger array and filter results into new array
